...
module.exports = class Transport {
    ...
    set datelocalformat(d) {
        this._datelocalformat = d;
    }
    get datelocalformat() {
        return this._datelocalformat || this.logger.datelocalformat;
    }
    async flush() {
    ...
    async _process(data, ops) {
        ...
        if (this.dateformat)
            data.timestamp = DateTime.fromJSDate(data.timestamp).toFormat(this.dateformat);
        else
            data.timestamp = DateTime.fromJSDate(data.timestamp).toLocaleString(this.datelocalformat);
